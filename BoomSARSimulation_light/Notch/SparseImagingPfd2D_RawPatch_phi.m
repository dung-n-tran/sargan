...
while 1
    ...
    makeDictionary(phi, tx_x(i:j), tx_y(i:j), tx_z(i:j), rx_x(i:j), rx_y(i:j), rx_z(i:j));
    ...
    function [] = makeDictionary(phi, tx_x, tx_y, tx_z, rx_x, rx_y, rx_z)
        ...
        for n = 1:NumGrid
            ...
            data = phi*generateTDRawData(tx_x, tx_y, tx_z, rx_x, rx_y, rx_z, p_target, s0_notch, t0_notch, fs, tAcq);
                   
            D(:, n) = data(:);
        end
    end

    function[] = makeDictionary_1(phi, tx_x, tx_y, tx_z, rx_x, rx_y, rx_z)
        %MAKEDICTIONARY : Makes dictionary for denoising SAR images (the parabolas). An
        % atom in the dictionary is the raw data corresponding to a point
        % on the grid.
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
