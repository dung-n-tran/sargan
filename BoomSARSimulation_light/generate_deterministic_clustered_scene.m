...
% target_indices = [4, 9, 6, 13, 15, 18, 31, 33, 36];
target_indices = [2, 7, 8, 9, 14, 23, 29, 35];
...
save("deterministic_clutter_scene_dict_atom_distance_20.mat", "scene_raw_data", "scene_image", "sar_dict", "n_samples", "n_apertures", "pulse",  "pulse_sampling_period");
