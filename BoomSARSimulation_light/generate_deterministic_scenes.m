...
scene_raw_data = sum(sar_dict(:, target_indices), 2);
...
% save("deterministic_scene_dict_atom_distance_20.mat", "scene_raw_data", "scene_image", "sar_dict", "n_samples", "n_apertures", "pulse",  "pulse_sampling_period");
